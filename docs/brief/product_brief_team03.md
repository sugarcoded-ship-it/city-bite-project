...
### Customer-facing (authentication required — self-registered account)
...
- **Infrastructure dependency:** Keycloak must be running as a Docker service in the development and demo environment. The system cannot authenticate customers, staff, or the owner without it.
